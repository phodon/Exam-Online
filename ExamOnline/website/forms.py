...
class SignUpForm(UserCreationForm):
    ...
    firstname = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'placeholder':'First Name'}))
    lastname = forms.CharField(label="",max_length=100,widget=forms.TextInput(attrs={'placeholder':'Last Name'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password2'].help_text = '<span><small>Enter the same password as before, for verification.</small></span>'	
        
class AddRecordForm(forms.ModelForm):
    first_name = forms.CharField(required=True, widget=forms.TextInput(attrs={'placeholder':'First Name'}), label="")
    ...
    address = forms.CharField(required=True, label="",widget=forms.TextInput(attrs={'placeholder':'Address'}))
    phone = forms.CharField(required=True, label="",widget=forms.TextInput(attrs={'placeholder':'Phone Number'}))
    city = forms.CharField(required=True, label="",widget=forms.TextInput(attrs={'placeholder':'City'}))
    state = forms.CharField(required=True, label="",widget=forms.TextInput(attrs={'placeholder':'State'}))
    zipcode = forms.CharField(required=True, label="",widget=forms.TextInput(attrs={'placeholder':'Zip Code'}))
